...
protected:
  ...
  boost::optional<geometry_msgs::PoseStamped> goal_msg_;
  geometry_msgs::PoseArray obs_list_;
  boost::optional<geometry_msgs::PolygonStamped> footprint_;
  boost::optional<nav_msgs::Path> edge_points_on_path_;
